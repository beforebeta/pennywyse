...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field merchants on 'Article'
        m2m_table_name = db.shorten_name(u'articles_article_merchants')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('article', models.ForeignKey(orm[u'articles.article'], null=False)),
            ('merchant', models.ForeignKey(orm[u'core.merchant'], null=False))
        ))
        db.create_unique(m2m_table_name, ['article_id', 'merchant_id'])

        # Adding M2M table for field categories on 'Article'
        m2m_table_name = db.shorten_name(u'articles_article_categories')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('article', models.ForeignKey(orm[u'articles.article'], null=False)),
    ...
    def backwards(self, orm):
        # Removing M2M table for field merchants on 'Article'
        db.delete_table(db.shorten_name(u'articles_article_merchants'))

        # Removing M2M table for field categories on 'Article'
        db.delete_table(db.shorten_name(u'articles_article_categories'))
    ...
    models = {
        ...
        u'core.category': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 19, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 19, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
