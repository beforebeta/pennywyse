...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ClickTrack.referrer'
        db.delete_column(u'tracking_clicktrack', 'referrer')

        # Adding field 'ClickTrack.referer'
        db.add_column(u'tracking_clicktrack', 'referer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ClickTrack.merchant_domain'
        db.add_column(u'tracking_clicktrack', 'merchant_domain',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'ClickTrack.target_url'
        db.alter_column(u'tracking_clicktrack', 'target_url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'ClickTrack.source_url_type'
        db.alter_column(u'tracking_clicktrack', 'source_url_type', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'ClickTrack.visitor'
        db.alter_column(u'tracking_clicktrack', 'visitor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracking.Visitor'], null=True))

        # Changing field 'ClickTrack.source_url'
        db.alter_column(u'tracking_clicktrack', 'source_url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'ClickTrack.user_agent'
        db.alter_column(u'tracking_clicktrack', 'user_agent', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Adding field 'ClickTrack.referrer'
        db.add_column(u'tracking_clicktrack', 'referrer',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Deleting field 'ClickTrack.referer'
        db.delete_column(u'tracking_clicktrack', 'referer')

        # Deleting field 'ClickTrack.merchant_domain'
        db.delete_column(u'tracking_clicktrack', 'merchant_domain')


        # Changing field 'ClickTrack.target_url'
        db.alter_column(u'tracking_clicktrack', 'target_url', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'ClickTrack.source_url_type'
        db.alter_column(u'tracking_clicktrack', 'source_url_type', self.gf('django.db.models.fields.CharField')(default='', max_length=10))

        # Changing field 'ClickTrack.visitor'
        db.alter_column(u'tracking_clicktrack', 'visitor_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['tracking.Visitor']))

        # Changing field 'ClickTrack.source_url'
        db.alter_column(u'tracking_clicktrack', 'source_url', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'ClickTrack.user_agent'
        db.alter_column(u'tracking_clicktrack', 'user_agent', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
