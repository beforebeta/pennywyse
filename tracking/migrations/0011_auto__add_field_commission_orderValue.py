...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Commission.orderValue'
        db.add_column(u'tracking_commission', 'orderValue',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Commission.orderValue'
        db.delete_column(u'tracking_commission', 'orderValue')
