...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Visitor.past_acquisition_info'
        db.add_column(u'tracking_visitor', 'past_acquisition_info',
                      self.gf('picklefield.fields.PickledObjectField')(default=[]),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Visitor.past_acquisition_info'
        db.delete_column(u'tracking_visitor', 'past_acquisition_info')
