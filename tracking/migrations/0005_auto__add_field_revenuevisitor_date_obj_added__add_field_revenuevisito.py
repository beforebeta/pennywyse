...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RevenueVisitor.date_obj_added'
        db.add_column(u'tracking_revenuevisitor', 'date_obj_added',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 12, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'RevenueVisitor.last_obj_modified'
        db.add_column(u'tracking_revenuevisitor', 'last_obj_modified',
    ...
    def backwards(self, orm):
        # Deleting field 'RevenueVisitor.date_obj_added'
        db.delete_column(u'tracking_revenuevisitor', 'date_obj_added')

        # Deleting field 'RevenueVisitor.last_obj_modified'
        db.delete_column(u'tracking_revenuevisitor', 'last_obj_modified')
