...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'RedirectionTrack'
        db.delete_table(u'tracking_redirectiontrack')

        # Adding model 'SearchQueryLog'
        db.create_table(u'tracking_searchquerylog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('query', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('visitor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracking.Visitor'], null=True, blank=True)),
            ('redirected', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('found_merchants', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('found_coupons', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 20, 0, 0), auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'tracking', ['SearchQueryLog'])


    def backwards(self, orm):
        # Adding model 'RedirectionTrack'
        db.create_table(u'tracking_redirectiontrack', (
            ('merchant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Merchant'], null=True, blank=True)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 18, 0, 0), auto_now_add=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('visitor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracking.Visitor'], null=True, blank=True)),
        ))
        db.send_create_signal(u'tracking', ['RedirectionTrack'])

        # Deleting model 'SearchQueryLog'
        db.delete_table(u'tracking_searchquerylog')
    ...
    models = {
        ...
        u'core.category': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 20, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 20, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'tracking.clicktrack': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 20, 0, 0)'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 20, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 20, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'merchant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Merchant']", 'null': 'True', 'blank': 'True'}),
        ...
        u'tracking.revenuevisitor': {
            ...
            'acquisition_term': ('django.db.models.fields.CharField', [], {'default': "'direct'", 'max_length': '255'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 20, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'date_obj_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 20, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip_address': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 20, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'last_obj_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 20, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'tracking.searchquerylog': {
            'Meta': {'object_name': 'SearchQueryLog'},
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 20, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'found_coupons': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'found_merchants': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
