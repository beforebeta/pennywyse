...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AdCost'
        db.create_table(u'tracking_adcost', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cost_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('start_date', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ...
            ('impression', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('social_impression', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('clicks', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('social_clicks', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('costs', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('average_cpc', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ...
            ('unique_clicks', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.send_create_signal(u'tracking', ['AdCost'])


    def backwards(self, orm):
        # Deleting model 'AdCost'
        db.delete_table(u'tracking_adcost')
    ...
    models = {
        ...
        u'tracking.clicktrack': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 8, 0, 0)'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 8, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 8, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'merchant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Merchant']", 'null': 'True', 'blank': 'True'}),
        ...
        u'tracking.revenuevisitor': {
            ...
            'acquisition_term': ('django.db.models.fields.CharField', [], {'default': "'direct'", 'max_length': '255'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 8, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'date_obj_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 8, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip_address': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 8, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'last_obj_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 8, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
