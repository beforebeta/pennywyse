...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClickTrack.acquisition_source'
        db.add_column(u'tracking_clicktrack', 'acquisition_source',
                      self.gf('django.db.models.fields.CharField')(default='direct', max_length=255),
                      keep_default=False)

        # Adding field 'ClickTrack.acquisition_medium'
        db.add_column(u'tracking_clicktrack', 'acquisition_medium',
                      self.gf('django.db.models.fields.CharField')(default='direct', max_length=255),
                      keep_default=False)

        # Adding field 'ClickTrack.acquisition_term'
        db.add_column(u'tracking_clicktrack', 'acquisition_term',
                      self.gf('django.db.models.fields.CharField')(default='direct', max_length=255),
                      keep_default=False)

        # Adding field 'ClickTrack.acquisition_content'
        db.add_column(u'tracking_clicktrack', 'acquisition_content',
                      self.gf('django.db.models.fields.CharField')(default='direct', max_length=255),
                      keep_default=False)

        # Adding field 'ClickTrack.acquisition_campaign'
        db.add_column(u'tracking_clicktrack', 'acquisition_campaign',
                      self.gf('django.db.models.fields.CharField')(default='direct', max_length=255),
                      keep_default=False)

        # Adding field 'ClickTrack.acquisition_gclid'
        db.add_column(u'tracking_clicktrack', 'acquisition_gclid',
                      self.gf('django.db.models.fields.CharField')(default='direct', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClickTrack.acquisition_source'
        db.delete_column(u'tracking_clicktrack', 'acquisition_source')

        # Deleting field 'ClickTrack.acquisition_medium'
        db.delete_column(u'tracking_clicktrack', 'acquisition_medium')

        # Deleting field 'ClickTrack.acquisition_term'
        db.delete_column(u'tracking_clicktrack', 'acquisition_term')

        # Deleting field 'ClickTrack.acquisition_content'
        db.delete_column(u'tracking_clicktrack', 'acquisition_content')

        # Deleting field 'ClickTrack.acquisition_campaign'
        db.delete_column(u'tracking_clicktrack', 'acquisition_campaign')

        # Deleting field 'ClickTrack.acquisition_gclid'
        db.delete_column(u'tracking_clicktrack', 'acquisition_gclid')
    ...
    models = {
        ...
        u'core.category': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 15, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 15, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'tracking.clicktrack': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 15, 0, 0)'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 15, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 15, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'merchant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Merchant']", 'null': 'True', 'blank': 'True'}),
        ...
        u'tracking.revenuevisitor': {
            ...
            'acquisition_term': ('django.db.models.fields.CharField', [], {'default': "'direct'", 'max_length': '255'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 15, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'date_obj_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 15, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip_address': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 15, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'last_obj_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 15, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
