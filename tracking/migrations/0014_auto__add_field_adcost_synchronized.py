...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdCost.synchronized'
        db.add_column(u'tracking_adcost', 'synchronized',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AdCost.synchronized'
        db.delete_column(u'tracking_adcost', 'synchronized')
