...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RevenueVisitor.visitor'
        db.alter_column(u'tracking_revenuevisitor', 'visitor_id', self.gf('django.db.models.fields.related.OneToOneField')(default=None, unique=True, primary_key=True, to=orm['tracking.Visitor']))
        # Adding unique constraint on 'RevenueVisitor', fields ['visitor']
        db.create_unique(u'tracking_revenuevisitor', ['visitor_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'RevenueVisitor', fields ['visitor']
        db.delete_unique(u'tracking_revenuevisitor', ['visitor_id'])
        ...
        # Changing field 'RevenueVisitor.visitor'
        db.alter_column(u'tracking_revenuevisitor', 'visitor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['tracking.Visitor']))
    ...
    models = {
        ...
        u'tracking.revenuevisitor': {
            'Meta': {'ordering': "('-last_update',)", 'object_name': 'RevenueVisitor', '_ormbases': [u'tracking.Visitor']},
            ...
            'visitor': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'rev_visitor'", 'unique': 'True', 'primary_key': 'True', 'to': u"orm['tracking.Visitor']"})
        },
