...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RevenueVisitor'
        db.create_table(u'tracking_revenuevisitor', (
            (u'visitor_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['tracking.Visitor'], unique=True, primary_key=True)),
            ('visitor', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='rev_visitor', null=True, to=orm['tracking.Visitor'])),
        ))
        db.send_create_signal(u'tracking', ['RevenueVisitor'])


    def backwards(self, orm):
        # Deleting model 'RevenueVisitor'
        db.delete_table(u'tracking_revenuevisitor')
