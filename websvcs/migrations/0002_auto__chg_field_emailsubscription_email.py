...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EmailSubscription.email'
        db.alter_column(u'websvcs_emailsubscription', 'email', self.gf('django.db.models.fields.EmailField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'EmailSubscription.email'
        db.alter_column(u'websvcs_emailsubscription', 'email', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        u'websvcs.emailsubscription': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 24, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
