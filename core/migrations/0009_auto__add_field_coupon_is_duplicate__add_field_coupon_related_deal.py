...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Coupon.is_duplicate'
        db.add_column(u'core_coupon', 'is_duplicate',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Coupon.related_deal'
        db.add_column(u'core_coupon', 'related_deal',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Coupon'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Coupon.is_duplicate'
        db.delete_column(u'core_coupon', 'is_duplicate')

        # Deleting field 'Coupon.related_deal'
        db.delete_column(u'core_coupon', 'related_deal_id')
    ...
    models = {
        u'core.category': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 10, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'is_featured': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 10, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
