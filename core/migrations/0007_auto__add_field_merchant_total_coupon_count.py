...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Merchant.total_coupon_count'
        db.add_column(u'core_merchant', 'total_coupon_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Merchant.total_coupon_count'
        db.delete_column(u'core_merchant', 'total_coupon_count')
