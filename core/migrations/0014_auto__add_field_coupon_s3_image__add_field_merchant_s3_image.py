...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Coupon.s3_image'
        db.add_column(u'core_coupon', 's3_image',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Merchant.s3_image'
        db.add_column(u'core_merchant', 's3_image',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Coupon.s3_image'
        db.delete_column(u'core_coupon', 's3_image')

        # Deleting field 'Merchant.s3_image'
        db.delete_column(u'core_merchant', 's3_image')
