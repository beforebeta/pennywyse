...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_category', 'icon',
                      self.gf('django.db.models.fields.TextField')(default=u'/static/img/category_icons/placeholder.jpg', null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.navigation_section'
        db.add_column(u'core_category', 'navigation_section',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web.CategorySection'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Coupon.popularity'
        db.add_column(u'core_coupon', 'popularity',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Coupon.coupon_type'
        db.add_column(u'core_coupon', 'coupon_type',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Coupon.featured_in'
        db.add_column(u'core_coupon', 'featured_in',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'featured', null=True, to=orm['web.TopCouponSection']),
                      keep_default=False)

        # Adding field 'Coupon.popular_in'
        db.add_column(u'core_coupon', 'popular_in',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'popular', null=True, to=orm['web.TopCouponSection']),
                      keep_default=False)

        # Adding field 'Merchant.is_featured'
        db.add_column(u'core_merchant', 'is_featured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Merchant.popularity'
        db.add_column(u'core_merchant', 'popularity',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Merchant.navigation_section'
        db.add_column(u'core_merchant', 'navigation_section',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'stores', null=True, to=orm['web.TopCouponSection']),
                      keep_default=False)

        # Adding M2M table for field similar on 'Merchant'
        m2m_table_name = db.shorten_name(u'core_merchant_similar')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_merchant', models.ForeignKey(orm[u'core.merchant'], null=False)),
            ('to_merchant', models.ForeignKey(orm[u'core.merchant'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_merchant_id', 'to_merchant_id'])


    def backwards(self, orm):
        # Deleting field 'Category.icon'
        db.delete_column(u'core_category', 'icon')

        # Deleting field 'Category.navigation_section'
        db.delete_column(u'core_category', 'navigation_section_id')

        # Deleting field 'Coupon.popularity'
        db.delete_column(u'core_coupon', 'popularity')

        # Deleting field 'Coupon.coupon_type'
        db.delete_column(u'core_coupon', 'coupon_type')

        # Deleting field 'Coupon.featured_in'
        db.delete_column(u'core_coupon', 'featured_in_id')

        # Deleting field 'Coupon.popular_in'
        db.delete_column(u'core_coupon', 'popular_in_id')

        # Deleting field 'Merchant.is_featured'
        db.delete_column(u'core_merchant', 'is_featured')

        # Deleting field 'Merchant.popularity'
        db.delete_column(u'core_merchant', 'popularity')

        # Deleting field 'Merchant.navigation_section'
        db.delete_column(u'core_merchant', 'navigation_section_id')

        # Removing M2M table for field similar on 'Merchant'
        db.delete_table(db.shorten_name(u'core_merchant_similar'))
    ...
    models = {
        u'core.category': {
            ...
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 3, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'core.merchantaffiliatedata': {
            'Meta': {'object_name': 'MerchantAffiliateData'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'merchant': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'affiliate_data'", 'to': u"orm['core.Merchant']"}),
            'network': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'networkid': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'networknote': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
