...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CityPicture'
        db.create_table(u'core_citypicture', (
        ...
        db.send_create_signal(u'core', ['CityPicture'])


    def backwards(self, orm):
        # Deleting model 'CityPicture'
        db.delete_table(u'core_citypicture')
    ...
    models = {
        u'core.category': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 8, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
