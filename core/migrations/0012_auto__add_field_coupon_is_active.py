...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Coupon.is_active'
        db.add_column(u'core_coupon', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Coupon.is_active'
        db.delete_column(u'core_coupon', 'is_active')
    ...
    models = {
        u'core.category': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 6, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 6, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
