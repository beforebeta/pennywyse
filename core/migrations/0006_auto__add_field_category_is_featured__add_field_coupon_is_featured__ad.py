...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.is_featured'
        db.add_column(u'core_category', 'is_featured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Coupon.is_featured'
        db.add_column(u'core_coupon', 'is_featured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Coupon.is_new'
        db.add_column(u'core_coupon', 'is_new',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Coupon.is_popular'
        db.add_column(u'core_coupon', 'is_popular',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.is_featured'
        db.delete_column(u'core_category', 'is_featured')

        # Deleting field 'Coupon.is_featured'
        db.delete_column(u'core_coupon', 'is_featured')

        # Deleting field 'Coupon.is_new'
        db.delete_column(u'core_coupon', 'is_new')

        # Deleting field 'Coupon.is_popular'
        db.delete_column(u'core_coupon', 'is_popular')
    ...
    models = {
        u'core.category': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 22, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'is_featured': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 22, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
